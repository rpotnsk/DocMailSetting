...
%\input{tex/p1.tex}% Алгоритм работы торгового представителя на маршруте
%\input{tex/p2.tex}% Последовательность работы торгового представителя с планшетным устройством
%\input{tex/p3.tex}% Работа в торговой точке
%\input{tex/p4.tex}
%\input{tex/p5.tex}
%\input{tex/p6.tex}
